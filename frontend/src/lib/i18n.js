...
const de = {
  ...
  products: {
    ...
    label_vendor: 'Hersteller', label_size: 'Größe', label_unit: 'Bestandseinheit', label_entry_unit: 'Erfassen Einheit', label_entry_unit_hint: 'Standard-Einheit beim Erfassen von Beständen', label_category: 'Kategorie',
    label_name: 'Name', placeholder_vendor: 'Hersteller', placeholder_size: 'z.B. 500ml',
  ...
  scanner: {
    ...
    placeholder_vendor: 'Hersteller', label_size: 'Größe', placeholder_size: 'z.B. 500ml',
...
const en = {
  ...
  products: {
    ...
    label_vendor: 'Vendor', label_size: 'Size', label_unit: 'Stock Unit', label_entry_unit: 'Entry Unit', label_entry_unit_hint: 'Default unit when adding stock entries', label_category: 'Category',
    label_name: 'Name', placeholder_vendor: 'Vendor', placeholder_size: 'e.g. 500ml',
  ...
  scanner: {
    ...
    label_vendor: 'Vendor', placeholder_vendor: 'Vendor', label_size: 'Size', placeholder_size: 'e.g. 500ml',
